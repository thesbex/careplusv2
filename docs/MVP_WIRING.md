...
| 5.5d | QA-fix : prescription distincte par type (LAB / IMAGING) | ⏳ NEXT | — | Backend : `GET /catalog/lab-tests?q=` + `GET /catalog/imaging-exams?q=`. Frontend : `PrescriptionDrawer` choisit le hook search en fonction du `type`. |
